...
public class AuthenticationPage extends AbstractPage {
    ...
    public void clickAuthenticationPasswordNull(){
        clickLogIn.click();
        checkAndScreenShot("Проверяем наличие ошибки о некорректности введенных данных. Пустой пароль",
    ...
    public void clickAuthenticationEmailNull(){
        clickLogIn.click();
        checkAndScreenShot("Проверяем наличие ошибки о некорректности введенных данных. Пустой email",
    ...
    public void clickAuthenticationError(){
        clickLogIn.click();
        checkAndScreenShot("Проверяем наличие ошибки о некорректности введенных данных",
